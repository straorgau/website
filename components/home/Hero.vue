<template>
  <!-- 
   <div class="hero bg-base-200">
    <div class="hero-content max-w-[100rem] py-8 lg:py-0">
      <div class="max-w-2xl gap-4">
        ...
        <p class="py-6">
          We are the Student Transport Riders Association, the chief advocacy group for students and young people on public transport in Victoria.
        </p>
  ...
  -->
   <div class="max-w-full grid grid-cols-1 place-items-center bg-inherit px-4 md:px-0">
